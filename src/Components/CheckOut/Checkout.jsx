...
const Checkout = () => {
   ...
   useEffect(()=>{
    ...
    for(let i=0;i<items.length;i++)
    {
        ...
        sum = sum+parseInt(items[i].products.price)
    }
    let shipping = 22
            ...
            <div className=" md:max-w-7xl mx-auto">
                ...
                <div className="md:flex space-x-10">
                    ...
                    <div className=' md:max-w-full '>
                        <p className='font-semibold text-center'>Summary Order</p>
                        <div className="hero ">
                                ...
                                <div className=" border-l-2">
                                    <form className="card-body">
                                        <div className="form-control">
                                            ...
                                            <div className="flex">
                                            <input type="text" name='promo' placeholder="Enter Promo code" className="input-sm input input-bordered w-full " required />
